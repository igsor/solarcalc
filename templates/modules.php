...
function t_editableHardware($data, $submitButtonName, $id)
{
    for($i=0; $i<count($data); $i++) {
        $data[$i]['formid'] = "form_{$id}_{$i}";
    }
...
function t_editablePanel($data, $submitButtonName, $id)
{
    for($i=0; $i<count($data); $i++) {
        $data[$i]['formid'] = "form_{$id}_{$i}";
    }
...
function t_editableBattery($data, $submitButtonName, $id)
{
    for($i=0; $i<count($data); $i++) {
        $data[$i]['formid'] = "form_{$id}_{$i}";
    }
