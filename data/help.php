...
$HELP_TEXT = [
    ...
    'total_panel_power'  => '<h4>Total panel power</h4> This value give the total amount of power that is available from all panels together. For example, you have two panels. One with 200 W and one with 120 W. Then the total panel power is 200 W + 120 W = 320 W.',
    'consumed_power_day'  => '<h4>Consumed power (day)</h4> This value gives the maximum power that is drawn from the panels by the loads only, during the day. This means, only the devices which are used during the day are counted. The power which is flowing into the battery is not counted.',
    'unused_panel_power'  => '<h4>Unused panel power</h4> This value describes how much of the panel power is not needed to support the system. To calculate this value, take the total panel power and subtract the consumed power during the day and the required energy for the battery during the night. What remains is the unused panel power.',
    'consumed_energy_day'  => '<h4>Consumed energy (day)</h4> This value calculated how much energy is consumed by the loads during the day. The calculation is:<br/>consumed energy (day) = sum( device amount * device power * device dayhours)',
    ...
    'helptext' => '<h4>Help text</h4> This is an example help text. In this text, some extensive explanations, formulas or other important hint might be given. THese helptext cover most of the table titles and other elements. Hoover your mouse over any element you wish to know more about and with a bit of luck, there exists a help text.',
    '' => '<h4></h4>',
    '' => '<h4></h4>',
    '' => '<h4></h4>',
